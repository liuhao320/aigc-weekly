...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_payload_locked_documents_rels\`("id", "order", "parent_id", "path", "users_id", "weekly_id", "media_id") SELECT "id", "order", "parent_id", "path", "users_id", "weekly_id", "media_id" FROM \`payload_locked_documents_rels\`;`)
